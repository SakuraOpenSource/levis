...
type ConfigField struct {
	...
	// key 是配置项标识，落库键名为 plugin:<插件 ID>:<key>。
...
const file_plugin_proto_rawDesc = "" +
	...
	"\fQueryPayment\x12$.levis.plugin.v1.QueryPaymentRequest\x1a\".levis.plugin.v1.QueryPaymentReplyB?Z=github.com/SakuraOpenSource/levis/pkg/plugin/proto;protob\x06proto3"
